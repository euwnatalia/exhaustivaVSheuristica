...
def busqueda_heuristica(posicion_inicial, objetivo):
    cola = []
...
# Uso del algoritmo
posicion_inicial = 0
objetivo = 7  # Supongamos que la posición objetivo es 7
resultado = busqueda_heuristica(posicion_inicial, objetivo)
print("Posición encontrada usando heurística:", resultado if resultado is not None else "No encontrada")
